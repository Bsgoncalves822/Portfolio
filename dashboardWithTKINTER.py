...
#Chart 2- Horizontal Bar Chart - Inventory Data
...
#Chart 3- Pie Chart - Product Data
...
#Chart 4- Line Chart - Sales Year Data
fig4, ax4 = plt.subplots()
ax4.plot(list(sales_year_data.keys()), list(sales_year_data.values()))
ax4.set_title("Sales Over Years")
ax4.set_xlabel("Year")
ax4.set_ylabel("Sales")
#plt.show()

#chart 5- Area Chart - Inventory Month Data
...
label = tk.Label(side_frame, text="Dashboard", bg= "#4C2A85", fg="white", font=25)
